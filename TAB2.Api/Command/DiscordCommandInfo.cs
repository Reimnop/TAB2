...
public class DiscordCommandInfo
{
    ...
    public DiscordCommandInfo AddIntArgument(string name, string description, bool isRequired = false)
    {
    ...
    public DiscordCommandInfo AddStringArgument(string name, string description, bool isRequired = false)
    {
